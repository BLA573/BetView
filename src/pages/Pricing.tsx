...
import { Check, Building2, Crown, Rocket, Star, ArrowLeft } from "lucide-react";
...
const agencyTiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Lead notifications + priority routing",
      "Agency public profile with badge",
      "Request property scans",
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-6">
                  <div className={`w-11 h-11 rounded-xl flex items-center justify-center ${
                    tier.popular ? "gradient-blue shadow-blue" : "bg-secondary"
                  }`}>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredPlans.map((plan) => (
              <div
                key={plan.duration}
                className={`rounded-2xl p-6 border transition-all hover:-translate-y-1 duration-300 ${
                  plan.popular
                    ? "border-primary bg-primary/[0.03] shadow-blue"
              ...
              >
                {plan.popular && (
                  <span className="inline-block px-3 py-0.5 rounded-full gradient-blue text-xs font-semibold text-white mb-3 shadow-blue">
                    Recommended
                  </span>
                )}
      ...
      <section id="contact-pricing" className="py-20 px-6" style={{ background: "hsl(215,66%,10%)" }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="mailto:info@betview.et"
              className="px-8 py-4 rounded-xl gradient-blue text-white font-semibold shadow-blue hover:opacity-90 transition-all"
            >
            ...
            <a
              ...
              style={{ border: "1px solid hsl(215,40%,22%)" }}
            >
              Call Us
            </a>
          </div>
